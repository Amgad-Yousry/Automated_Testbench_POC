# 1 "../FreeMASTER/src_common/freemaster_serial.c"
...
# 1 "../FreeMASTER/src_common/freemaster_serial.c"
# 16 "../FreeMASTER/src_common/freemaster_serial.c"
...
# 17 "../FreeMASTER/src_common/freemaster_serial.c" 2
...
# 18 "../FreeMASTER/src_common/freemaster_serial.c" 2
...
# 19 "../FreeMASTER/src_common/freemaster_serial.c" 2
# 39 "../FreeMASTER/src_common/freemaster_serial.c"
...
# 70 "../FreeMASTER/src_common/freemaster_serial.c"
    } flg;
...
# 115 "../FreeMASTER/src_common/freemaster_serial.c"
static void FMSTR_Listen(void);
static void FMSTR_SendError(FMSTR_BCHR nErrCode);
# 131 "../FreeMASTER/src_common/freemaster_serial.c"
static FMSTR_BCHR pcm_pRQueueBuffer[32];
static FMSTR_BPTR pcm_pRQueueRP;
static FMSTR_BPTR pcm_pRQueueWP;
...
# 158 "../FreeMASTER/src_common/freemaster_serial.c"
static void FMSTR_RxQueue(FMSTR_BCHR nRxChar)
{
    ...
    if(wpnext >= (pcm_pRQueueBuffer + 32))
    {
...
# 190 "../FreeMASTER/src_common/freemaster_serial.c"
static void FMSTR_RxDequeue(void)
{
    FMSTR_BCHR nChar = 0U;
    ...
    while(pcm_pRQueueRP != pcm_pRQueueWP)
    {
        ...
        if(pcm_pRQueueRP >= (pcm_pRQueueBuffer + 32))
        {
...
# 229 "../FreeMASTER/src_common/freemaster_serial.c"
void FMSTR_ProcessSCI(void)
{

    FMSTR_SCISR wSciSR = ((*(volatile FMSTR_U32*)(((FMSTR_U32)(0x4006B000UL))+(0x14)))>>16); (*(volatile FMSTR_U32*)(((FMSTR_U32)(0x4006B000UL))+(0x14)) = (*(volatile FMSTR_U32*)(((FMSTR_U32)(0x4006B000UL))+(0x14))));;
    ...
    if (pcm_wFlags.flg.bTxActive)
    {
        ...
        if(!(!((wSciSR) & 0x80)))
        {
            ...
            if(!FMSTR_Tx(&ch))
                (*(volatile FMSTR_U8*)(((FMSTR_U32)(0x4006B000UL))+(0x1C)) = (FMSTR_U8) ch);
        }
# 258 "../FreeMASTER/src_common/freemaster_serial.c"
        if(((wSciSR) & (0x20 | 0x08)))
        {

            volatile FMSTR_U16 nRxChar;
            nRxChar = (*(volatile FMSTR_U8*)(((FMSTR_U32)(0x4006B000UL))+(0x1C)));
            (void)(nRxChar);
        }
    ...
    else
    {
        ...
        if (((wSciSR) & (0x20 | 0x08)))
        {
            ...
            nRxChar = (FMSTR_BCHR) (*(volatile FMSTR_U8*)(((FMSTR_U32)(0x4006B000UL))+(0x1C)));
...
# 294 "../FreeMASTER/src_common/freemaster_serial.c"
    }
}
# 1064 "../FreeMASTER/src_common/freemaster_serial.c"
static void FMSTR_Listen(void)
{
    pcm_nRxTodo = 0U;
    ...
    ((*(volatile FMSTR_U32*)(((FMSTR_U32)(0x4006B000UL))+(0x18))) &= ~(0x080000));
    ((*(volatile FMSTR_U32*)(((FMSTR_U32)(0x4006B000UL))+(0x18))) |= 0x040000);
    ...
    ((*(volatile FMSTR_U32*)(((FMSTR_U32)(0x4006B000UL))+(0x18))) &= ~(0x800000));
    ((*(volatile FMSTR_U32*)(((FMSTR_U32)(0x4006B000UL))+(0x18))) |= 0x200000);
# 1107 "../FreeMASTER/src_common/freemaster_serial.c"
}
# 1117 "../FreeMASTER/src_common/freemaster_serial.c"
static void FMSTR_SendError(FMSTR_BCHR nErrCode)
{
...
# 1136 "../FreeMASTER/src_common/freemaster_serial.c"
void FMSTR_SendResponse(FMSTR_BPTR pResponse, FMSTR_SIZE8 nLength)
{
    ...
    pResponse = ( (*((FMSTR_U8*)(pResponse)) = (FMSTR_U8)((FMSTR_U8) (((FMSTR_U8)(~chSum)) + 1U))), (((FMSTR_BPTR)(pResponse))+1) );
...

    {
        ...
        dummySR = (*(volatile FMSTR_U32*)(((FMSTR_U32)(0x4006B000UL))+(0x14)));
        (*(volatile FMSTR_U8*)(((FMSTR_U32)(0x4006B000UL))+(0x1C)) = 0x2bU);
        (void)(dummySR);
    }
# 1200 "../FreeMASTER/src_common/freemaster_serial.c"
    ((*(volatile FMSTR_U32*)(((FMSTR_U32)(0x4006B000UL))+(0x18))) &= ~(0x200000));
    ((*(volatile FMSTR_U32*)(((FMSTR_U32)(0x4006B000UL))+(0x18))) |= 0x800000);
# 1236 "../FreeMASTER/src_common/freemaster_serial.c"
}
# 1248 "../FreeMASTER/src_common/freemaster_serial.c"
FMSTR_BOOL FMSTR_Tx(FMSTR_U8* pTxChar)
{
# 1259 "../FreeMASTER/src_common/freemaster_serial.c"
    if (pcm_nTxTodo)
    {


        (void)( (*((FMSTR_U8*)(pTxChar)) = *(FMSTR_U8*)(pcm_pTxBuff)), (((FMSTR_BPTR)(pcm_pTxBuff))+1) );
...
# 1293 "../FreeMASTER/src_common/freemaster_serial.c"
    FMSTR_Listen();
...
# 1315 "../FreeMASTER/src_common/freemaster_serial.c"
    ...
    if(pcm_nRxTodo)
    {
        ...
        else
        {
            ...
            if(pcm_pRxBuff)
            {
                ...
                if(pcm_pRxBuff < (pcm_pCommBuffer + (((8)*5)+18+2)))
                {
...
FMSTR_BOOL FMSTR_InitSerial(void)
{
    ...
    pcm_wFlags.all = 0U;
    pcm_nTxTodo = 0U;
# 1467 "../FreeMASTER/src_common/freemaster_serial.c"
    pcm_pRQueueRP = pcm_pRQueueBuffer;
    pcm_pRQueueWP = pcm_pRQueueBuffer;
# 1488 "../FreeMASTER/src_common/freemaster_serial.c"
    FMSTR_Listen();
    return (1U);
}
# 1535 "../FreeMASTER/src_common/freemaster_serial.c"
void FMSTR_Poll(void)
{
# 1573 "../FreeMASTER/src_common/freemaster_serial.c"
    FMSTR_RxDequeue();
# 1583 "../FreeMASTER/src_common/freemaster_serial.c"
}
