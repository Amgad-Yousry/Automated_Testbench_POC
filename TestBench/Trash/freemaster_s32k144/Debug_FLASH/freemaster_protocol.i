# 1 "../FreeMASTER/src_common/freemaster_protocol.c"
...
# 1 "../FreeMASTER/src_common/freemaster_protocol.c"
# 16 "../FreeMASTER/src_common/freemaster_protocol.c"
...
# 17 "../FreeMASTER/src_common/freemaster_protocol.c" 2
...
# 18 "../FreeMASTER/src_common/freemaster_protocol.c" 2
...
# 19 "../FreeMASTER/src_common/freemaster_protocol.c" 2
# 38 "../FreeMASTER/src_common/freemaster_protocol.c"
FMSTR_BOOL FMSTR_Init(void)
{
    ...
    FMSTR_InitAppCmds();
# 67 "../FreeMASTER/src_common/freemaster_protocol.c"
    FMSTR_InitPipes();
# 89 "../FreeMASTER/src_common/freemaster_protocol.c"
    if (!FMSTR_InitSerial())
        return (0U);
...
# 115 "../FreeMASTER/src_common/freemaster_protocol.c"
FMSTR_BOOL FMSTR_ProtocolDecoder(FMSTR_BPTR pMessageIO)
{
    ...
    switch (nCmd)
    {
        ...
        case 0x06U:
            ...
            break;
# 357 "../FreeMASTER/src_common/freemaster_protocol.c"
        case 0xc0U:

            pResponseEnd = FMSTR_GetBoardInfo(pMessageIO);
            break;
# 374 "../FreeMASTER/src_common/freemaster_protocol.c"
        case 0x15U:
...
# 414 "../FreeMASTER/src_common/freemaster_protocol.c"
FMSTR_BOOL FMSTR_SendTestFrame(FMSTR_BPTR pMessageIO)
{
...
# 433 "../FreeMASTER/src_common/freemaster_protocol.c"
FMSTR_BPTR FMSTR_GetBoardInfo(FMSTR_BPTR pMessageIO)
{
    FMSTR_BPTR pResponse = pMessageIO;
    FMSTR_U16 wTmp;
...
# 460 "../FreeMASTER/src_common/freemaster_protocol.c"
...
# 481 "../FreeMASTER/src_common/freemaster_protocol.c"
...
# 510 "../FreeMASTER/src_common/freemaster_protocol.c"
FMSTR_BPTR FMSTR_ReadMem(FMSTR_BPTR pMessageIO)
{
    FMSTR_BPTR pResponse = pMessageIO;
    FMSTR_ADDR nAddr;
...
# 528 "../FreeMASTER/src_common/freemaster_protocol.c"
...
# 550 "../FreeMASTER/src_common/freemaster_protocol.c"
FMSTR_BPTR FMSTR_ReadVar(FMSTR_BPTR pMessageIO, FMSTR_SIZE8 nSize)
{
    FMSTR_BPTR pResponse = pMessageIO;
    FMSTR_ADDR nAddr;
    ...
    pMessageIO = FMSTR_AddressFromBuffer(&nAddr, pMessageIO);
# 566 "../FreeMASTER/src_common/freemaster_protocol.c"
    pResponse = ( (*((FMSTR_U8*)(pResponse)) = (FMSTR_U8)(0x00U)), (((FMSTR_BPTR)(pResponse))+1) );

    return FMSTR_CopyToBuffer(pResponse, nAddr, nSize);
}
# 582 "../FreeMASTER/src_common/freemaster_protocol.c"
FMSTR_BPTR FMSTR_WriteMem(FMSTR_BPTR pMessageIO)
{
    FMSTR_BPTR pResponse = pMessageIO;
    FMSTR_ADDR nAddr;
    ...
    pMessageIO = ( (*((FMSTR_U8*)(&nSize)) = *(FMSTR_U8*)(pMessageIO)), (((FMSTR_BPTR)(pMessageIO))+1) );
    pMessageIO = FMSTR_AddressFromBuffer(&nAddr, pMessageIO);
# 601 "../FreeMASTER/src_common/freemaster_protocol.c"
...
# 623 "../FreeMASTER/src_common/freemaster_protocol.c"
FMSTR_BPTR FMSTR_WriteVar(FMSTR_BPTR pMessageIO, FMSTR_SIZE8 nSize)
{
    FMSTR_BPTR pResponse = pMessageIO;
    FMSTR_ADDR nAddr;
    ...
    pMessageIO = ( ((FMSTR_BPTR)(pMessageIO)) + (1U) );
    pMessageIO = FMSTR_AddressFromBuffer(&nAddr, pMessageIO);
# 641 "../FreeMASTER/src_common/freemaster_protocol.c"
...
# 663 "../FreeMASTER/src_common/freemaster_protocol.c"
FMSTR_BPTR FMSTR_WriteMemMask(FMSTR_BPTR pMessageIO)
{
    FMSTR_BPTR pResponse = pMessageIO;
    FMSTR_ADDR nAddr;
    ...
    pMessageIO = ( (*((FMSTR_U8*)(&nSize)) = *(FMSTR_U8*)(pMessageIO)), (((FMSTR_BPTR)(pMessageIO))+1) );
    pMessageIO = FMSTR_AddressFromBuffer(&nAddr, pMessageIO);
# 691 "../FreeMASTER/src_common/freemaster_protocol.c"
...
# 713 "../FreeMASTER/src_common/freemaster_protocol.c"
FMSTR_BPTR FMSTR_WriteVarMask(FMSTR_BPTR pMessageIO, FMSTR_SIZE8 nSize)
{
    FMSTR_BPTR pResponse = pMessageIO;
    FMSTR_ADDR nAddr;
    ...
    pMessageIO = ( ((FMSTR_BPTR)(pMessageIO)) + (1U) );
    pMessageIO = FMSTR_AddressFromBuffer(&nAddr, pMessageIO);
# 731 "../FreeMASTER/src_common/freemaster_protocol.c"
...
# 748 "../FreeMASTER/src_common/freemaster_protocol.c"
FMSTR_U16 FMSTR_StrLen(FMSTR_ADDR nAddr)
{
    const char* pStr;
    FMSTR_U16 nLen = 0U;
