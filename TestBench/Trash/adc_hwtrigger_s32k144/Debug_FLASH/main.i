# 1 "../Sources/main.c"
# 1 "C:\\Users\\kamil\\OneDrive\\Documents\\GitHub\\Internship\\TestBench\\adc_hwtrigger_s32k144\\Debug_FLASH//"
# 1 "<built-in>"
#define __STDC__ 1
...
uint16_t gfCurrentVector [10000];
# 87 "../Sources/main.c"
...
# 206 "../Sources/main.c"
 while (1)
 {
  if (adcConvDone == 1)
  {
   ...
   gfCurrentVector[0] = (uint16_t) (gfCurrentValue*1000);
