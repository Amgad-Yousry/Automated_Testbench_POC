...
void PDB_IRQHandler(void)
{
 ...
 PINS_DRV_WritePin(((GPIO_Type *)(0x400FF0C0u)),7U,flag);
}
...
# 126 "../Sources/main.c"
    ...
    if(!calculateIntValue(&pdly1_InitConfig0, 5000UL, &pdbIntValue))
    {
    ...
    PINS_DRV_ClearPins(((GPIO_Type *)(0x400FF0C0u)), (uint32_t) (1 << 7U));
    ...
    PDB_DRV_SetAdcPreTriggerDelayValue((0U), 0UL, 0UL, (uint32_t) delayValue);
