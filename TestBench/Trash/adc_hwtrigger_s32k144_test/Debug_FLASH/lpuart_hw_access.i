# 1 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.4/platform/drivers/src/lpuart/lpuart_hw_access.c"
...
# 1 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.4/platform/drivers/src/lpuart/lpuart_hw_access.c"
# 42 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.4/platform/drivers/src/lpuart/lpuart_hw_access.c"
...
# 43 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.4/platform/drivers/src/lpuart/lpuart_hw_access.c" 2
# 55 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.4/platform/drivers/src/lpuart/lpuart_hw_access.c"
void LPUART_Init(LPUART_Type * base)
{

    base->BAUD = ((uint32_t)(((0x0FUL) << 24u) |
                 ((0x04UL) << 0u)));
    ...
    base->FIFO = (0x00030000U);

    base->WATER = 0x00000000;

}
# 88 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.4/platform/drivers/src/lpuart/lpuart_hw_access.c"
void LPUART_SetBitCountPerChar(LPUART_Type * base,
                                   lpuart_bit_count_per_char_t bitCountPerChar)
{
    if (bitCountPerChar == LPUART_10_BITS_PER_CHAR)
    {
        base->BAUD = (base->BAUD & ~0x20000000u) | ((uint32_t)1U << 29u);
    }
    else
    {

        base->CTRL = (base->CTRL & ~0x10u) | ((uint32_t)bitCountPerChar << 4u);

        base->BAUD &= ~0x20000000u;
    }
}
# 114 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.4/platform/drivers/src/lpuart/lpuart_hw_access.c"
void LPUART_SetParityMode(LPUART_Type * base, lpuart_parity_mode_t parityModeType)
{
    base->CTRL = (base->CTRL & ~0x2u) | (((uint32_t)parityModeType >> 1U) << 1u);
    base->CTRL = (base->CTRL & ~0x1u) | (((uint32_t)parityModeType & 1U) << 0u);
}
# 127 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.4/platform/drivers/src/lpuart/lpuart_hw_access.c"
void LPUART_Putchar9(LPUART_Type * base, uint16_t data)
{
    ...
    base->CTRL = (base->CTRL & ~0x40000000u) | ((uint32_t)(ninthDataBit) << 30u);


    dataRegBytes[0] = (uint8_t)data;
}
# 149 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.4/platform/drivers/src/lpuart/lpuart_hw_access.c"
void LPUART_Putchar10(LPUART_Type * base, uint16_t data)
{
    ...
    ctrlRegVal = (ctrlRegVal & ~0x40000000u) | ((uint32_t)ninthDataBit << 30u);
    ctrlRegVal = (ctrlRegVal & ~0x80000000u) | ((uint32_t)tenthDataBit << 31u);
    base->CTRL = ctrlRegVal;


    dataRegBytes[0] = (uint8_t)data;
}
# 175 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.4/platform/drivers/src/lpuart/lpuart_hw_access.c"
void LPUART_Getchar9(const LPUART_Type * base, uint16_t *readData)
{
    ((void)0);


    *readData = (uint16_t)(((base->CTRL >> 31u) & 1U) << 8);


    *readData |= (uint8_t)base->DATA;
}
# 194 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.4/platform/drivers/src/lpuart/lpuart_hw_access.c"
void LPUART_Getchar10(const LPUART_Type * base, uint16_t *readData)
{
    ((void)0);


    *readData = (uint16_t)(((base->CTRL >> 30u) & 1U) << 9);
...
# 215 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.4/platform/drivers/src/lpuart/lpuart_hw_access.c"
void LPUART_SetIntMode(LPUART_Type * base, lpuart_interrupt_t intSrc, _Bool enable)
{
    uint32_t reg = (uint32_t)(intSrc) >> (16U);
    ...
    switch (reg)
    {
        case (1U):
            ...
            break;
        case (2U):
            base->STAT = (base->STAT & (~(0xC01FC000U) & ~(1UL << intRegOffset))) |
        ...
        case (7U):
            base->FIFO = (base->FIFO & (~(0x00030000U) & ~(1UL << intRegOffset))) |
                         ((enable ? 1U : 0U) << intRegOffset);
            break;
...
# 262 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.4/platform/drivers/src/lpuart/lpuart_hw_access.c"
_Bool LPUART_GetIntMode(const LPUART_Type * base, lpuart_interrupt_t intSrc)
{
    uint32_t reg = (uint32_t)(intSrc) >> (16U);
    _Bool retVal = 0;
...
# 309 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.4/platform/drivers/src/lpuart/lpuart_hw_access.c"
_Bool LPUART_GetStatusFlag(const LPUART_Type * base, lpuart_status_flag_t statusFlag)
{
    uint32_t reg = (uint32_t)(statusFlag) >> (16U);
    _Bool retVal = 0;
...
# 357 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.4/platform/drivers/src/lpuart/lpuart_hw_access.c"
                                    ...
                                    lpuart_status_flag_t statusFlag)
{
    ...
    switch(statusFlag)
    {
        ...
        case LPUART_IDLE_LINE_DETECT:
            base->STAT = (base->STAT & (~(0xC01FC000U))) | 0x100000u;
            break;

        case LPUART_RX_OVERRUN:
            base->STAT = (base->STAT & (~(0xC01FC000U))) | 0x80000u;
            break;

        case LPUART_NOISE_DETECT:
            base->STAT = (base->STAT & (~(0xC01FC000U))) | 0x40000u;
            break;

        case LPUART_FRAME_ERR:
            base->STAT = (base->STAT & (~(0xC01FC000U))) | 0x20000u;
            break;

        case LPUART_PARITY_ERR:
            base->STAT = (base->STAT & (~(0xC01FC000U))) | 0x10000u;
            break;

        case LPUART_LIN_BREAK_DETECT:
            base->STAT = (base->STAT & (~(0xC01FC000U))) | 0x80000000u;
            break;

        case LPUART_RX_ACTIVE_EDGE_DETECT:
            base->STAT = (base->STAT & (~(0xC01FC000U))) | 0x40000000u;
            break;


        case LPUART_MATCH_ADDR_ONE:
            base->STAT = (base->STAT & (~(0xC01FC000U))) | 0x8000u;
            break;
        case LPUART_MATCH_ADDR_TWO:
            base->STAT = (base->STAT & (~(0xC01FC000U))) | 0x4000u;
            break;


        case LPUART_FIFO_TX_OF:
            base->FIFO = (base->FIFO & (~(0x00030000U))) | 0x20000u;
            break;
        case LPUART_FIFO_RX_UF:
            base->FIFO = (base->FIFO & (~(0x00030000U))) | 0x10000u;
            break;
