# 1 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.4/platform/drivers/src/edma/edma_hw_access.c"
...
# 1 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.4/platform/drivers/src/edma/edma_hw_access.c"
# 23 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.4/platform/drivers/src/edma/edma_hw_access.c"
...
# 24 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.4/platform/drivers/src/edma/edma_hw_access.c" 2
# 34 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.4/platform/drivers/src/edma/edma_hw_access.c"
void EDMA_Init(DMA_Type * base)
{
    uint8_t i;
...
# 152 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.4/platform/drivers/src/edma/edma_hw_access.c"
void EDMA_TCDClearReg(DMA_Type * base,uint8_t channel)
{
                ...
                edma_transfer_size_t srcTransferSize, edma_transfer_size_t destTransferSize)
{
    ...
    regValTemp = (uint16_t)(((uint16_t)srcModulo << 11u) | ((uint16_t)srcTransferSize << 8u));
    regValTemp |= (uint16_t)(((uint16_t)destModulo << 3u) | ((uint16_t)destTransferSize << 0u));
    base->TCD[channel].ATTR = regValTemp;
}
...
void EDMA_TCDSetChannelMinorLink(
                DMA_Type * base, uint8_t channel, uint32_t linkChannel, _Bool enable)
{
...
void EDMA_TCDSetMajorCount(DMA_Type * base, uint8_t channel, uint32_t count)
{
    ...
    uint16_t regValTemp;
    if (((base->TCD[channel].BITER.ELINKNO & 0x8000u) >> 15u) != 0U)
    {
        regValTemp = base->TCD[channel].BITER.ELINKYES;
