...
/* Obs: This must be declared as global, otherwise it changes its value during the cycles and idk why*/
...
//	 = {
//			 	.txSize = 2U,                       /* Size of the TX buffer*/
//			    .rxSize = 2U,                        /* Size of the RX buffer*/
//			    .txBuff = 72U,                /* Pointer to Tx Buffer*/
//			    .rxBuff = 73U,                       /* Pointer to Rx Buffer*/
	...
	// };
	 ...
	 LPI2C_DRV_MasterSendDataBlocking(INST_LPI2C1, SEND, TRANSFER_SIZE, true, 100U);
	    ...
	    LPI2C_DRV_MasterReceiveDataBlocking(INST_LPI2C1, buffer, TRANSFER_SIZE, true, 100U);
