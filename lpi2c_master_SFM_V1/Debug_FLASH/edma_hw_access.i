# 1 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/edma/edma_hw_access.c"
...
# 1 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/edma/edma_hw_access.c"
# 23 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/edma/edma_hw_access.c"
...
# 24 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/edma/edma_hw_access.c" 2
# 34 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/edma/edma_hw_access.c"
void EDMA_Init(DMA_Type * base)
{
    uint8_t i;
# 59 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/edma/edma_hw_access.c"
    uint32_t regValTemp;
    regValTemp = base->CR;
    regValTemp &= ~(0x40u);
    regValTemp &= ~(0x20000u);
...
{
    uint32_t regValTemp;
# 91 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/edma/edma_hw_access.c"
    regValTemp = base->CR;
    regValTemp &= ~(0x20000u);
...
{
    uint32_t regValTemp;
# 116 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/edma/edma_hw_access.c"
    regValTemp = base->CR;
    regValTemp &= ~(0x10000u);
...
void EDMA_SetErrorIntCmd(DMA_Type * base, uint8_t channel, _Bool enable)
{
# 145 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/edma/edma_hw_access.c"
    if (enable)
    {
        base->SEEI = channel;
    }
...
void EDMA_SetDmaRequestCmd(DMA_Type * base, uint8_t channel,_Bool enable)
{
# 176 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/edma/edma_hw_access.c"
    if (enable)
    {
        base->SERQ = channel;
    }
...
# 229 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/edma/edma_hw_access.c"
void EDMA_TCDClearReg(DMA_Type * base, uint8_t channel)
{
...
void EDMA_TCDSetNbytes(DMA_Type * base, uint8_t channel, uint32_t nbytes)
{
    ...
    DevAssert(channel < (16U));
# 296 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/edma/edma_hw_access.c"
...
void EDMA_TCDSetMinorLoopOffset(DMA_Type * base, uint8_t channel, int32_t offset)
{
    ...
    DevAssert(channel < (16U));
# 345 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/edma/edma_hw_access.c"
    if (((base->CR & 0x80u) >> 7u) != 0UL)
    {
        _Bool mlOffNo = 0;
        if (((base->TCD[channel].NBYTES.MLOFFNO & 0x80000000u) >> 31u) != 0UL)
                ...
                DMA_Type * base, uint8_t channel, uint32_t linkChannel, _Bool enable)
{
    ...
    DevAssert(channel < (16U));
    DevAssert(linkChannel < (16U));
# 429 "C:/NXP/S32DS_ARM_v2.0/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/edma/edma_hw_access.c"
    uint16_t regValTemp;
